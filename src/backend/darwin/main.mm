...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        @autoreleasepool
        {
            ...
            renderPassDescriptor.colorAttachments[0].clearColor = MTLClearColorMake((double)(clear_color[0] * clear_color[3]), (double)(clear_color[1] * clear_color[3]), (double)(clear_color[2] * clear_color[3]), (double)clear_color[3]);
